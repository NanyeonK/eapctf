#!/usr/bin/env python3
"""Run archived IPCA benchmark object with exposure-instability uncertainty."""
...
class JointIPCAExposureInstabilityReport:
...
def main() -> None:
    ...
    model = ArchivedIPCAExposureInstabilityModel(lookback_months=12, min_history=2, uncertainty_floor=1e-6)
    ...
    report = JointIPCAExposureInstabilityReport(
